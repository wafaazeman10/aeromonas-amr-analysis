Antimicrobial Resistance Analysis (Aeromonas, Malaysia 2014–2020)
...
(Optional: Tableau Public — only if you actually used it.)

🎯 SMART Questions Answered

How do resistance rates vary by specimen type (blood, tissue, stool, swab)?

Which antibiotic classes show the highest and lowest resistance?

How do AMR profiles differ across species (A. caviae, A. hydrophila, A. sobria)?

Do resistance patterns change over time (2014–2020)?

Which predictors (species, specimen type, antibiotic class, year) are significant in a binomial GLM?
